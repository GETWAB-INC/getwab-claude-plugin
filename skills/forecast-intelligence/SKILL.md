...
Detailed source semantics: [playbook](../research/references/playbooks/forecasting.txt). Read when detailed field interpretation is necessary. SQL in playbooks is reference data, not an executable capability.
