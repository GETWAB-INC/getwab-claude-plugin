...
Detailed source semantics: [playbook](../research/references/playbooks/fpds_awards.txt). Read when detailed field interpretation is necessary. SQL in playbooks is reference data, not an executable capability.
