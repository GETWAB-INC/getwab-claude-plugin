...
Detailed source semantics: [playbook](../playbooks/sba_subnet.txt). Read when detailed field interpretation is necessary. SQL in playbooks is reference data, not an executable capability.
